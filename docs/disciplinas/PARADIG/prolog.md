...
- Átomos devem começar com letra minúsculas. No caso de estarem delimitadas por áspas simples podem ter maíusculas e espaços.
- Variáveis devem iniciar ou letra maiúsucla ou underline.
...
geeralização recurssao rastreamento
