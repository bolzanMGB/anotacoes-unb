...
**3. GPOS (General Purpose Operating System)** Com Sistema Operacional de propósito geral, é um linux customizado e reduzido para a aplicação.
...
## 3. Camada Intermediária (Middleware)
